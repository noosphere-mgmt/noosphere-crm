...
CREATE TABLE IF NOT EXISTS properties_v1 (
  ...
  walking_minutes        INTEGER NULL,
  facilities             TEXT NULL,
  facilities_zh          TEXT NULL,
  facilities_cn          TEXT NULL,
  green_certification    TEXT NULL,
  lot_number             TEXT NULL,
  grade                  TEXT NULL,
  ...
  building_relationship_lines JSONB NOT NULL DEFAULT '[]'::jsonb,
...
CREATE TABLE IF NOT EXISTS premises_v1 (
  ...
  property_name_en_is_custom BOOLEAN NOT NULL DEFAULT FALSE,
  property_name_zh       TEXT NULL,
  property_name_zh_is_custom BOOLEAN NOT NULL DEFAULT FALSE,
  property_name_cn       TEXT NULL,
  property_name_cn_is_custom BOOLEAN NOT NULL DEFAULT FALSE,
  ...
  no_of_rooms            TEXT NULL,
  office_name            TEXT NULL,
  office_type            TEXT NULL,
  gross_area_sqft        NUMERIC(14, 2) NULL,
  net_area_sqft          NUMERIC(14, 2) NULL,
  gross_area_sqm         NUMERIC(14, 2) NULL,
  net_area_sqm           NUMERIC(14, 2) NULL,
  view_type              TEXT NULL,
  windows                TEXT NULL,
  management_fee         NUMERIC(14, 2) NULL,
  management_fee_psf     NUMERIC(14, 2) NULL,
  government_rates       NUMERIC(14, 2) NULL,
  remarks                TEXT NULL,
