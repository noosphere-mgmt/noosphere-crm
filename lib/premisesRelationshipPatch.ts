...
export async function buildPremisesRelationshipLinesPatch(
  ...
  return {
    ...
    occupant_lease_commencement: synced.occupant_lease_commencement,
    occupant_lease_expiry: synced.occupant_lease_expiry,
    occupant_lease_term: synced.occupant_lease_term,
